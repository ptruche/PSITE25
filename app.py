...
# --- Sidebar hard fix: force render & width; also remove top white space globally
st.markdown("""
<style>
/* Ensure the sidebar is ALWAYS visible and at top */
...
/* Kill Streamlit header gap & toolbar */
