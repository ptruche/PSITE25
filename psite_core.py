...
# - Theming
# - Auth with persisted login (cookies + URL + localStorage)
# - SCORE topic catalog + slug helpers
# - Question + review loading (recursive, per-topic folders)
# - Progress, analytics, and spaced repetition (SM-2 lite)
# ---------------------------------------------------------------------
